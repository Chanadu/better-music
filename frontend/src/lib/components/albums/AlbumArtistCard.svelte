...
<section class="group/artist-card order-1 h-full md:col-start-1 md:row-start-1">
	<a
		class="bg-base-200 focus-visible:outline-primary group-hover/artist-card:bg-primary/10 relative flex h-full min-h-72 items-center justify-center gap-4 overflow-hidden rounded-2xl p-5 shadow-lg transition duration-200 ease-out group-hover/artist-card:-translate-y-1 group-hover/artist-card:scale-[1.02] group-hover/artist-card:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-4 active:translate-y-0 active:scale-[0.98] active:shadow-sm active:duration-75 motion-reduce:transform-none sm:gap-8 sm:p-8"
	...
	>
		<div class="relative w-1/2 shrink-0">
			{#if artist.cover_url && !imageFailed}
				<img
					class="bg-base-300 aspect-square w-full rounded-full object-cover shadow-2xl ring-4 ring-white/10"
		...
		<div class="relative min-w-0 flex-1 text-left">
			...
			<h2 class="mt-1 text-2xl font-black tracking-tight text-white sm:text-3xl">
				{artist.name}
			</h2>
		</div>
	</a>
